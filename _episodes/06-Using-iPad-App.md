...
**Mac Deployment**: The latest version of the app can be downloaded at [https://www-users.cse.umn.edu/~hmuramat/iOS/CPAProductionChecklists-3-95.zip](https://www-users.cse.umn.edu/~hmuramat/iOS/CPAProductionChecklists-3-95.zip). To do so you will need **Username**: `DUNE` and **Password**: `DUNEana`.
