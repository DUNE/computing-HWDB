...
![shipping menu](../fig/ShippingProcedure/shipping_menu_iPad.jpg){: .image-with-shadow}{: width="50%"}
...
![packing default](../fig/ShippingProcedure/packing_0.jpg){: .image-with-shadow}{: width="50%"}
...
![packing type](../fig/ShippingProcedure/packing_1.jpg){: .image-with-shadow}{: width="50%"}
...
![packing pid](../fig/ShippingProcedure/packing_2.jpg){: .image-with-shadow}{: width="50%"}
...
![preshipping step 1](../fig/ShippingProcedure/preshipping_1.jpg){: .image-with-shadow}{: width="50%"}
